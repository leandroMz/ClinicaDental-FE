window.addEventListener('load', function () {
    ...
    formulario.addEventListener('submit', function (event) {
       ...
       //creamos un JSON que tendrá los datos del nuevo odon
        const formData = {
            numeroMatricula: document.querySelector('#numeroMatricula').value,
            categoria: document.querySelector('#nombre').value,
            premios: document.querySelector('#apellido').value,
    ...
    (function(){
        ...
        } else if (pathname == "/html/odontologos/get_odontologos.html") {
